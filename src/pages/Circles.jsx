...
const BUSINESS_RESPONSE = {
  ...
  lines: [
    ...
    { bold: 'Total: ~$501K' },
    { html: '<strong>Brand / churn signal:</strong> social mentions up <strong>9.4Ã—</strong>, NPS detractors trending <strong>+18 pts</strong> in affected ZIPs. Predicted churn lift: <strong>+0.7%</strong> (~1,290 subs).' },
          ...
          <div className="gs-phone-outer">
            <div className="gs-phone">
              <div className="gs-phone-status">
                <span className="gs-phone-time-sm"></span>
              ...
              <div className="gs-phone-clock"></div>
